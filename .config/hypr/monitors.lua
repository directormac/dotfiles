...
hl.monitor({ output = "desc:LG Electronics LG ULTRAGEAR 308NTGY1D007", mode = "2560x1440@164.96", position = "0x0", scale = 1.0, vrr = 3, bitdepth = 10, supports_hdr = 1, sdr_min_luminance = 0.005, sdr_max_luminance = 200, sdrbrightness = 1.2, min_luminance = 0.3926, max_luminance = 409 })
hl.monitor({ output = "desc:GIGA-BYTE TECHNOLOGY CO. LTD. AORUS AD27QD 19110B001090", mode = "2560x1440@143.97", position = "2560x0", scale = 1.0, vrr = 3, bitdepth = 10, supports_hdr = 1, sdr_min_luminance = 0.005, sdr_max_luminance = 200, sdrbrightness = 1, min_luminance = 0, max_luminance = 418 })
hl.monitor({ output = "", mode = "preferred", position = "auto", scale = "auto" })
hl.config({ misc = { vrr = 3 }, render = { cm_auto_hdr = 2 } })
