...
## [Everything](https://github.com/brianblakely/omarchy-everything)
  ...
  ```sh 
    ...
    ~/.config/omarchy/plugins/jesseburlamaque.omarchy-find/bin/omarchy-find setup-keybind "SUPER + backslash"
  ```

  If the command is still not working do this as workaround
  ```sh
  cp ~/.config/omarchy/plugins/jesseburlamaque.omarchy-find/bin/omarchy-find ~/.local/bin/omarchy-find
  ```
  and put this in `~/.config/hypr/bindings.lua`
  ```lua
...
- [audio-controls](https://omarchyplugins.com/plugin.html?id=ssupt.audio-control)
...
- [Screen Time](https://omarchyplugins.com/plugin.html?id=agx.screen-time)
...
- [Omaconnect](https://omarchyplugins.com/plugin.html?id=omaconnect)

    ```sh 
      # omaconnect
      omarchy plugin add https://github.com/jitendradara12/omaconnect.git --enable
    ```


- [Vpn](https://omarchyplugins.com/plugin.html?id=jkoestinger.vpn)
...
- [reprise](https://github.com/mwaltzer/omarchy-reprise)


    ### Maybe

    - [AdGuard](https://omarchyplugins.com/plugin.html?id=io.github.thisisgm.adguard)
    - [Hyprland Submap](https://omarchyplugins.com/plugin.html?id=io.github.poctek.hyprland-submap)
    - [Mirror Android](https://omarchyplugins.com/plugin.html?id=sumiran.mirror-android)
    - [LocalSend](https://omarchyplugins.com/plugin.html?id=bredda.localsend)
    - [OmaLive](https://omarchyplugins.com/plugin.html?id=io.github.prudhviy99.omalive)
    - [AdvanmceAudio](https://omarchyplugins.com/plugin.html?id=ssupt.audio-control)
    - [Otoru](https://omarchyplugins.com/plugin.html?id=ussego.otoru)
    - [dictionary](https://omarchyplugins.com/plugin.html?id=tristonarmstrong.dictionary)
    - [OmaGPU](https://omarchyplugins.com/plugin.html?id=ucmz851.omagpu)
    - [Shell Settings](https://omarchyplugins.com/plugin.html?id=shell.settings)
    - [Removable drives](https://omarchyplugins.com/plugin.html?id=wian47.removable-drives)
    - [active window](https://omarchyplugins.com/plugin.html?id=crmne.active-window)
    - [app launcher](https://omarchyplugins.com/plugin.html?id=tyrsolution.app-launcher)
    - [xray](https://omarchyplugins.com/plugin.html?id=io.github.randazraik.xray)
    - [cloud](https://omarchyplugins.com/plugin.html?id=furmware.cloud)
    - [lyrics](https://omarchyplugins.com/plugin.html?id=crmne.lyrics)
    - [keybinds](https://omarchyplugins.com/plugin.html?id=meviusisback.keybinds)
    - [ws name](https://omarchyplugins.com/plugin.html?id=jankeesvw.workspace-name)
    - [localhost](https://omarchyplugins.com/plugin.html?id=emils.localhost)
    - [auto ws](https://omarchyplugins.com/plugin.html?id=tenzin.auto-workspace)
    - [spaces](https://omarchyplugins.com/plugin.html?id=io.github.chinofmaya.spaces)
    - [bitwarden](https://omarchyplugins.com/plugin.html?id=com.aktivesolutions.bw-vault)
    - [omaprox](https://omarchyplugins.com/plugin.html?id=io.github.andressm415.omaprox)
    - [downloads](https://omarchyplugins.com/plugin.html?id=io.github.rawritude.aria2)
    - [ufw](https://omarchyplugins.com/plugin.html?id=srozen.ufw)
