require('lazyload').on_vim_enter(function()
  ...
  vim.keymap.set('n', '<leader>dLl', function() osv.launch({ port = 8086 }) end, { desc = 'Debug Lua: launch server' })
  vim.keymap.set('n', '<leader>dLr', function() osv.run_this() end, { desc = 'Debug Lua: run this' })
